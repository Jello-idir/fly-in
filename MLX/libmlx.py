...
MLX_HEADLESS = (
    4,
)  # Run in headless mode, no window is created. (NOTE: Still requires some form of window manager such as xvfb)
...
mlx.mlx_image_to_window.argtypes = [
    ctypes.POINTER(mlx_t),
    ctypes.POINTER(mlx_image_t),
    c_int32,
    c_int32,
]
...
mlx.mlx_texture_to_image.argtypes = [
    ctypes.POINTER(mlx_t),
